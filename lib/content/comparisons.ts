...
export const conceptComparisons: ConceptComparison[] = [
  ...
  },
  {
    ...
    left: { label: "语法", entrySlug: "proof-and-derivability" },
    right: { label: "语义", entrySlug: "soundness-completeness" },
    shared:
      "都为“公式成立、推理有效”提供精确刻画，都在元逻辑层面谈论形式系统；可靠性与完全性定理负责说明两者何时互相吻合。",
    difference:
      "语法看符号操作：从公理与推理规则出发，能不能一行行写出到达结论的证明，每行都可机械核对；语义看真值条件：在所有解释下前提真时结论是否都真，验证往往要对无穷多个模型说理。检验动作是问“成立靠什么兑现”——拿出一列推导是语法，拿出模型分析是语义。",
    watch:
      "同一个“有效”两种所指：“语法上有效”指可证，“语义上有效”指所有解释都保真。一阶逻辑有完全性定理兜底，两路汇合；进入足够强的算术理论，哥德尔定理说明可证与为真必然分家。听人强调“证不出来”时先问层次：找不到证明是语法困境，给出反模型是语义判决。",
  },
  {
    slug: "consistency-vs-completeness",
    left: { label: "一致性", entrySlug: "godel-incompleteness" },
    right: { label: "完全性", entrySlug: "soundness-completeness" },
    shared:
      "都是系统的元层性质，都由系统内部的证明关系定义，也都是希尔伯特纲领想一举拿下、最终由哥德尔的结果重塑的目标。",
    difference:
      "一致性是底线：推不出矛盾，即不存在从公理出发同时证明 P 与 ¬P 的序列；完全性是封顶：该证的都证尽了——对逻辑系统指全部语义后承可证，对算术理论指恰好证尽标准模型中的真句子。检验动作：查一致性找“双双可证”，查完全性找“真而不可证”。",
    watch:
      "哥德尔两条定理各管一头：第一定理说足够强的一致算术理论不完全，第二定理说这样的理论证不出自身一致性。同一名词还横跨两个对象：一阶逻辑作为系统有完全性定理，算术理论作为系统被证明不完全——别拿“逻辑是完全的”去反驳“算术不完全”，两句说的不是同一个“完全”。",
  },
];
